...
ALTER TABLE `wp_search_form_products`  ADD `ingredients` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL AFTER `product_order`,  ADD `description` LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL AFTER `ingredients`;
